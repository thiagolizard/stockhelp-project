...
public class removeritem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_removeritem);
        Spinner spinner = (Spinner) findViewById(R.id.spnTipoJoia2);
        Spinner spinner2 = (Spinner) findViewById(R.id.spnMarcaJoia2);
        Spinner spinner3 = (Spinner) findViewById(R.id.spnTipoItem2);
